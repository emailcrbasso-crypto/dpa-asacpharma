      ...
      <header className="bg-[#0F62AC] sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <a
              href="/api/export?mode=anonimo"
              className="text-white text-xs font-medium bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              ↓ CSV Anônimo
            </a>
            <a
              href="/painel/relatorio?mode=completo"
              target="_blank"
              className="text-white text-xs font-medium bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              ↗ PDF Completo
            ...
            <a
              href="/painel/relatorio?mode=anonimo"
              target="_blank"
              className="text-white text-xs font-medium bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              ↗ PDF Anônimo
            ...
            <form action={logout}>
              <button
                type="submit"
                className="text-blue-300 hover:text-white text-xs flex items-center gap-1 transition-colors ml-1"
              >
